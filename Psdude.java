...
public class Psdude extends JPanel implements Runnable {
    ...
    private void clockLayout(Graphics g) {
        ...
        // String Written Text
        g.setColor(Color.black);
        g.drawString("Clock Design By Urman Ali", 300, 100);
    ...
    public void paint(Graphics g) {
        ...
        int str[] = { 0, 12, 24, 37, 48, 60, 70, 80, 89, 97, 103, 114, 117, 119, 119 };
        int str1[] = { 0, 10, 20, 30, 40, 50, 58, 66, 74, 86, 91, 95, 97, 99, 100 };
        int str2[] = { 0, 40, 69, 80 };
